...
function Guestbook() {
  ...
  if(details.agree_to_notifications === true ) {
    details.agree_to_notifications = 'on';
  }
...
if (personName.match(regExp)) {
  ...
  return;
    ...
    // navigate('/', { dataFromRegisteredUser: { } });
    // navigate('/', { state: { success: 'You have successfuly registered' }})
